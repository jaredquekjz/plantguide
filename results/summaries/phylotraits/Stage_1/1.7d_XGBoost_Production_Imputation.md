...
| Mean R² | 0.562 |
| Mean MdAPE | 39.3% |
| Best trait | logNmass (60% within ±25%, MdAPE=20.5%) |
...
| Mean MdAPE | 39.3% | 67.2% | 42% lower error |
| ±25% tolerance | 36.3% | 22% | 1.65× higher precision |
...
|-------|------|-----|---------|-------|------|------|------|---------|
| **logNmass** | 0.328 | 0.473 | 0.73 | 20.5% | 26.5% | **60.0%** | 89.2% | Good |
| **logSLA** | 0.480 | 0.522 | 0.69 | 29.6% | 17.5% | **42.8%** | 75.3% | Moderate |
| **logLA** | 1.449 | 0.532 | 0.68 | 74.9% | 7.2% | **15.8%** | 31.6% | Challenging |
| **logLDMC** | 0.461 | 0.374 | 0.79 | 22.2% | 25.7% | **55.4%** | 83.0% | Good |
| **logH** | 0.962 | 0.729 | 0.52 | 51.9% | 10.0% | **24.9%** | 48.2% | Challenging |
| **logSM** | 1.629 | 0.749 | 0.50 | 78.4% | 6.0% | **14.8%** | 29.6% | Challenging |
...
**Best performing: logNmass, logLDMC**

**logNmass** (Leaf nitrogen):
- RMSE: 0.328, R²: 0.473, MdAPE: 20.5%
- 60% of predictions within ±25% tolerance
- Distribution: IQR = 25.0%
- Interpretation: Good precision with moderate R² (trait has low variance)

**logLDMC** (Leaf dry matter content):
- RMSE: 0.461, R²: 0.374, MdAPE: 22.2%
- 55.4% of predictions within ±25%
- Distribution: IQR = 29.9%
- Interpretation: Good performance despite sparse data (24.6% coverage)

**Moderate performance: logSLA**

**logSLA** (Specific leaf area):
- RMSE: 0.480, R²: 0.522, MdAPE: 29.6%
- 42.8% of predictions within ±25%
- Distribution: IQR = 35.4%
- Interpretation: Moderate precision with moderate R²

**Challenging: logLA, logH, logSM**

**logLA** (Leaf area):
- RMSE: 1.449, R²: 0.532, MdAPE: 74.9%
- 15.8% of predictions within ±25%
- Distribution: Very wide (IQR = 110.6%)
- Interpretation: High variability makes percentage errors large despite good R²

**logH** (Plant height):
- RMSE: 0.962, R²: 0.729, MdAPE: 51.9%
- 24.9% of predictions within ±25%
- Distribution: Very wide (IQR = 60.7%)
- Interpretation: High R² due to large trait variance, but moderate absolute accuracy

**logSM** (Seed mass):
- RMSE: 1.629, R²: 0.749, MdAPE: 78.4%
- 14.8% of predictions within ±25%
- Distribution: Very wide (IQR = 118.8%)
- Interpretation: High R² but wide error distribution due to extreme trait variability (spans 12 orders of magnitude)
...
- Error range shows realistic prediction spread
- Tolerance bands show actual distribution of errors
- Example: logNmass MdAPE = 20.5%, with 60% within ±25%

**R² vs accuracy relationship:**
- **High R², challenging accuracy**: logH (R²=0.729, MdAPE=51.9%), logSM (R²=0.749, MdAPE=78.4%)
  - Large data variance makes RMSE small relative to variance, but percentage errors remain large
- **Moderate R², good accuracy**: logNmass (R²=0.473, MdAPE=20.5%), logLDMC (R²=0.374, MdAPE=22.2%)
  - Smaller data variance, tighter percentage error distributions
- **Better metric**: RMSE/SD ratio (0.50-0.73 = good, >0.80 = challenging)

**Trait difficulty hierarchy:**
- **Best**: logNmass (MdAPE = 20.5%), logLDMC (MdAPE = 22.2%)
- **Moderate**: logSLA (MdAPE = 29.6%)
- **Challenging**: logH (MdAPE = 51.9%), logLA (MdAPE = 74.9%), logSM (MdAPE = 78.4%)
...
|-------|------------|----------|-------------|----------------|-------------|-------------|
| **logH** | **0.729** | 0.359 | +103% | 51.9% | 79.4% | +35% |
| **logSM** | **0.749** | 0.145 | +417% | 78.4% | 93.9% | +17% |
| **logLA** | **0.532** | 0.200 | +166% | 74.9% | 85.2% | +12% |
| **logSLA** | **0.522** | 0.285 | +83% | 29.6% | 35.4% | +16% |
| **logNmass** | **0.473** | 0.171 | +177% | 20.5% | 27.1% | +24% |
| **logLDMC** | **0.374** | -6.019 | - | 22.2% | 82.1% | +73% |
| **Average** | **0.563** | **0.024** | **+2246%** | **39.3%** | **67.2%** | **+42%** |
...
2. **Prediction accuracy (MdAPE):**
   - XGBoost mean MdAPE = 39.3%
   - BHPMF mean MdAPE = 67.2%
   - XGBoost errors 42% lower

3. **Tolerance bands:**
   - XGBoost: 36.3% of predictions within ±25%
   - BHPMF: 22% of predictions within ±25%
   - XGBoost achieves 65% higher precision
...
**Conclusion:** XGBoost provides superior performance across all traits and metrics, particularly for R² and reliability. While tolerance bands are moderate for both methods (reflecting the inherent difficulty of trait imputation), XGBoost consistently outperforms BHPMF. BHPMF is not recommended for production trait imputation.
