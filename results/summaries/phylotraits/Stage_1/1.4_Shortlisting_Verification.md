...
- Recounted shortlist coverage:
  - 24 542 taxa total; `gbif_occurrence_count` buckets are 6 129 (zero), 6 733 (1–29), and 11,711 (≥30).
  - Among the ≥30 subset: median ≈ 360, 90th percentile ≈ 6 193, maximum 167 396.
  - `gbif_georeferenced_count` mirrors the totals: 11,710 taxa with ≥30 coordinate-bearing records, 6 731 with 1–29, 6 132 with none.
...
- ≥30 occurrences: 11,711 ✓
- Georeferenced ≥30: 11,710 ✓
...
| GBIF Coverage | ✓ PASSED | 11,711 shortlist (≥30); 1,084 modelling (≥30) |
