...
- **11,680** species have ≥30 GBIF occurrences (median ≈ 360; 90th percentile ≈ 6.19k; max 167,396)
- **6,733** species fall between 1-29 occurrences
- **6,098** species currently lack GBIF records (GBIF often tracks genus-level only)

**Georeferenced coverage**: 11,679 taxa have ≥30 coordinate-bearing records, 6,731 have 1-29, 6,101 have none.
