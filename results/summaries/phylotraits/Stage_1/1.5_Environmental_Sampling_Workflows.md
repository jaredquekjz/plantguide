...
- **Launch template**:
  ...
  ```
- **Inputs**:
- `data/stage1/stage1_shortlist_with_gbif.parquet` (11,711 taxa, ≥30 occurrences)
- `data/gbif/occurrence_plantae_wfo.parquet` (31,458,767 GBIF rows after filters)
...
- **Outputs per dataset**:
  - `data/stage1/<dataset>_occ_samples.parquet` (ZSTD, 31,458,767 rows)
...
### 3.3 Outputs
- `data/stage1/worldclim_species_quantiles.parquet` — 11,711 taxa × 253 columns.
- `data/stage1/soilgrids_species_quantiles.parquet` — 11,711 taxa × 169 columns.
- `data/stage1/agroclime_species_quantiles.parquet` — 11,711 taxa × 205 columns.
...
All artefacts contain 11,711 taxa; occurrence files retain 31,458,767 rows.
