...
```
Guild: Oak (20m) + Hazel (4m, light=5) + Woodland fern (0.5m, light=2) + Moss (0.05m, light=1)

Height pairs:
  Oak → Hazel: 16m diff, light=5 (flexible) → valid = 16 × 0.6 = 9.6
  Oak → Fern: 19.5m diff, light=2 (shade) → valid = 19.5
  Oak → Moss: 19.95m diff, light=1 (deep shade) → valid = 19.95
  Hazel → Fern: 3.5m diff, light=2 (shade) → valid = 3.5
  Hazel → Moss: 3.95m diff, light=1 (deep shade) → valid = 3.95
  Fern → Moss: 0.45m diff (< 2m threshold, skip)

Total valid = 9.6 + 19.5 + 19.95 + 3.5 + 3.95 = 56.5
Total invalid = 0
stratification_quality = 56.5 / 56.5 = 1.0

Forms: 4 unique (tree, shrub, fern, bryophyte)
form_diversity = (4-1) / 5 = 0.6

p5_raw = (1.0 × 0.7) + (0.6 × 0.3) = 0.70 + 0.18 = 0.88
...
```
Guild: Oak (20m) + Lettuce (0.3m, light=9) + Tomato (1.5m, light=8)

Height pairs:
  Oak → Lettuce: 19.7m diff, light=9 (sun-loving) → invalid = 19.7
  Oak → Tomato: 18.5m diff, light=8 (sun-loving) → invalid = 18.5
  Tomato → Lettuce: 1.2m diff (< 2m threshold, skip)

Total valid = 0
Total invalid = 19.7 + 18.5 = 38.2
stratification_quality = 0 / 38.2 = 0.0

Forms: 3 unique (tree, herb_veg, herb_salad)
form_diversity = (3-1) / 5 = 0.4

p5_raw = (0.0 × 0.7) + (0.4 × 0.3) = 0.0 + 0.12 = 0.12
...
```
Guild: Apple (5m) + Comfrey (0.8m, light=5) + Strawberry (0.2m, light=8)

Height pairs:
  Apple → Comfrey: 4.2m diff, light=5 (flexible) → valid = 4.2 × 0.6 = 2.52
  Apple → Strawberry: 4.8m diff, light=8 (sun-loving) → invalid = 4.8
  Comfrey → Strawberry: 0.6m diff (< 2m threshold, skip)

Total valid = 2.52
Total invalid = 4.8
stratification_quality = 2.52 / (2.52 + 4.8) = 0.34

Forms: 2 unique (tree, herb)
form_diversity = (2-1) / 5 = 0.2

p5_raw = (0.34 × 0.7) + (0.2 × 0.3) = 0.24 + 0.06 = 0.30

Interpretation: Partial stratification - comfrey works under apple, strawberry struggles
```
