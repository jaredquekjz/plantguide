# Stage 4.5: Data Flow and Integration Architecture
...
**Calibration**: Uses percentile normalization from `normalization_params_7plant.json`
...
│  │                                                           │  │
│  │  Process:                                                 │  │
│  │  1. Generate 10,000 random guilds (size 2 or 7)         │  │
...
- Document 4.4: Metric formulas and framework
- Framework Audit 20251104: Script alignment verification
