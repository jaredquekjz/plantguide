# Stage 1 — XGBoost Trait Imputation (mixgb)
...
Tested 5 permutations to identify optimal feature set before scaling to 11.7K species:
...
| 5th | Perm2 (no logs) | **1.885** ✗ | 2.128 | +211% / +21% | **WORST** - Log transforms essential for traits |
...
## 6. Key Takeaways (5 Permutations Complete)
...
4. ✅ **Works for all species** - no separate model needed for 6K+ plants without EIVE
5. ✅ **Phylogenetic codes are useless** - genus_code, family_code contribute <0.001%
6. ✅ **Ready for 11.7K scale-up** - Perm3 configuration validated, hyperparameters optimized
