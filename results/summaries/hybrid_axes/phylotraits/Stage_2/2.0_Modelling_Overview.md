...
**Dimensions:** 1,084 species × 273 features
...
| Environmental q50 | 100% (1,084 / 1,084) |
...
**Dimensions:** 11,680 species × 273 features (identical feature set to 1,084)
...
| Environmental q50 | 100% (11,680 / 11,680) |
| Categorical traits | 29-79% |
...
### 2.3 Unified Feature Inventory (273 features)
...
| **Environmental q50** | 156 | WorldClim (63) + SoilGrids (42) + Agroclim (51) medians |
| **TOTAL** | **273** | Same features across both tiers |
...
- Columns: ~268 features (273 - 5 provenance cols - 1 target EIVE + 1 y)
