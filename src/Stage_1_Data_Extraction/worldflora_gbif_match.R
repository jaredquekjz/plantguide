...
input_path <- file.path(repo_root, "data/stage1/gbif_occurrence_names_for_r.tsv")
output_path <- file.path(repo_root, "data/stage1/gbif_occurrence_wfo_worldflora.csv")
