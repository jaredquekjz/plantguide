...
# =============================================================================
# GBIF Cleaning Pipeline - No Sea Test Version
# =============================================================================
# Skips the problematic sea coordinate test that causes hangs
# Relaxed parameters for better real-world performance
...
# Define tests to run (excluding seas to avoid hanging, duplicates optional)
# Based on CoordinateCleaner documentation and GBIF best practices
# Default tests: capitals, centroids, equal, gbif, institutions, zeros
# Optional: duplicates (for SDM/richness analyses), outliers (compute-intensive)
tests_to_run <- c(
  ...
  "duplicates"     # Within-species duplicates (important for SDM)
)
...
cli_alert_warning("Note: Including duplicates test - suitable for SDM/richness analyses")
...
output_file <- file.path(config$output_dir, "all_occurrences_cleaned_noSea.csv")
