...
# =============================================================================
# GBIF Cleaning Pipeline - For 1,051 Matched Species
# =============================================================================
...
cli_h1("GBIF Cleaning Pipeline (1,051 Matched Species)")
...
# Load matched species list
suppressPackageStartupMessages(library(jsonlite))
matches <- fromJSON(config$matches_file)
matched_species <- matches$matched_species
cli_alert_info("Loaded {nrow(matched_species)} matched species from JSON")

# Use the GBIF files from matches
gbif_files <- matched_species$gbif_file
cli_alert_info("Will process {length(gbif_files)} species files")
