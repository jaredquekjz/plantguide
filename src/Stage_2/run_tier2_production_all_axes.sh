...
check_phylo_rank() {
    local axis=$1
    local shap_file="${OUTPUT_BASE}/${axis}_11680_production_20251029/xgb_${axis}_shap_importance.csv"
...
show_metrics() {
    local axis=$1
    local metrics_file="${OUTPUT_BASE}/${axis}_11680_production_20251029/xgb_${axis}_cv_metrics_kfold.json"
...
run_axis() {
    local axis=$1
    local features_csv="${FEATURE_DIR}/${axis}_features_11680_20251029.csv"
    local output_dir="${OUTPUT_BASE}/${axis}_11680_production_20251029"
...
for axis in "${AXES[@]}"; do
    output_dir="${OUTPUT_BASE}/${axis}_11680_production_20251029"
...
echo "========================================================================"
for axis in "${AXES[@]}"; do
    shap_file="${OUTPUT_BASE}/${axis}_11680_production_20251029/xgb_${axis}_shap_importance.csv"
    if [ -f "$shap_file" ]; then
