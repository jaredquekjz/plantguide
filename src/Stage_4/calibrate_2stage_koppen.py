...
def load_all_data(con):
    ...
    """).fetchdf() if Path('data/stage4/plant_organism_profiles.parquet').exists() else pd.DataFrame()
    ...
    """).fetchdf() if Path('data/stage4/plant_fungal_guilds_hybrid.parquet').exists() else pd.DataFrame()
