...
Input:
  ...
  - data/shipley_checks/stage3/bill_with_csr_ecoservices_11711.csv (new plant list)
...
# Paths
NEW_PLANTS_FILE = Path("data/shipley_checks/stage3/bill_with_csr_ecoservices_11711.csv")
WORLDCLIM_OCC = Path("data/stage1/worldclim_occ_samples.parquet")
EXISTING_KOPPEN = Path("data/stage1/worldclim_occ_samples_with_koppen.parquet")
OUTPUT_FILE = Path("data/stage1/worldclim_occ_samples_with_koppen_11711.parquet")
TEMP_DIR = Path("data/stage1/temp_koppen_11711")
...
2. Run integrate_koppen_to_plant_dataset_11711.py to merge with bill_with_csr_ecoservices_11711.csv
""")
