...
# File paths
KOPPEN_FILE = Path("data/stage4/plant_koppen_distributions_11711.parquet")
MAIN_DATASET = Path("data/shipley_checks/stage3/bill_with_csr_ecoservices_11711.csv")
OUTPUT_FILE = Path("data/shipley_checks/stage3/bill_with_csr_ecoservices_koppen_11711.parquet")
