...
ANIMAL_GENUS_DERIVED_FILE <- file.path(OUTPUT_DIR, "genus_vernaculars_derived_from_species.parquet")
ANIMAL_FAMILY_DERIVED_FILE <- file.path(OUTPUT_DIR, "family_vernaculars_derived_from_species.parquet")
