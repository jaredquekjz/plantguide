...
input_path <- 'model_data/inputs/mixgb/mixgb_input_20251022.csv'
output_path <- 'model_data/inputs/mixgb/mixgb_cv_rmse.csv'
...
drop_predictors <- c('leaf_area_source', 'nmass_source', 'ldmc_source', 'lma_source',
                     'height_source', 'seed_mass_source', 'try_parasitism',
                     'try_carnivory', 'try_succulence')
keep_cats <- c('try_woodiness', 'try_growth_form', 'try_habitat_adaptation',
               'try_leaf_type', 'Genus', 'Family')
