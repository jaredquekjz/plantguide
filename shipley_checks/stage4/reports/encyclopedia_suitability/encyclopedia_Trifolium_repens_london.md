...
#### In London, UK (Temperate)

| Parameter | Your Location | Plant Range | Status |
|-----------|---------------|-------------|--------|
| Frost days/year | 61 | 1–195 | ✓ |
| Warm nights (>20°C) | 0 | 0–108 | ✓ |
| Growing season (days) | 305 | 164–365 | ✓ |
...
| Parameter | Your Location | Plant Range | Status |
|-----------|---------------|-------------|--------|
| Annual rainfall (mm) | 593 | 443–1539 | ✓ |
| Max dry spell (days) | 12 | 8–28 | ✓ |
| Max wet spell (days) | 8 | 5–16 | ✓ |
...
|-----------|---------------|-------------|--------|
| Soil pH | 6.1 | 4.8–6.9 | ✓ |
| Fertility (CEC) | 32 | 15–44 | ✓ |
| Soil texture | Clay Loam | Unknown | ? |

### Suitability for London, UK (Temperate)

**Climate zone**: Humid Temperate (✓ observed) — plant found in: Mediterranean, Humid Temperate, Continental

**Overall**: ✅ Ideal conditions

Conditions at your location match where this plant naturally thrives.
