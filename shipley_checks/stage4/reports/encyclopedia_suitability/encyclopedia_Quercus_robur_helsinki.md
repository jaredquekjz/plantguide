...
|-----------|---------------|-------------|--------|
| Frost days/year | 162 | 4–90 | ↑ |
| Warm nights (>20°C) | 0 | 0–11 | ✓ |
| Growing season (days) | 170 | 275–365 | ↓ |

⚠️ **Significantly more frost days than where this plant is observed**
- Growing season much shorter than where this plant occurs
→ Consider cold-hardy alternatives from the same genus
→ Choose species adapted to shorter growing seasons
...
| Parameter | Your Location | Plant Range | Status |
|-----------|---------------|-------------|--------|
| Annual rainfall (mm) | 649 | 416–1515 | ✓ |
| Max dry spell (days) | 14 | 11–26 | ✓ |
| Max wet spell (days) | 7 | 7–16 | ✓ |
...
**Climate zone**: Continental (~ related) — plant found in: Mediterranean, Humid Temperate
