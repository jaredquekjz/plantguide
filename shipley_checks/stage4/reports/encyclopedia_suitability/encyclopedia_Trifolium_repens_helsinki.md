...
#### In Helsinki, Finland (Boreal)

| Parameter | Your Location | Plant Range | Status |
|-----------|---------------|-------------|--------|
| Frost days/year | 162 | 1–195 | ✓ |
| Warm nights (>20°C) | 0 | 0–108 | ✓ |
| Growing season (days) | 170 | 164–365 | ✓ |
...
| Parameter | Your Location | Plant Range | Status |
|-----------|---------------|-------------|--------|
| Annual rainfall (mm) | 649 | 443–1539 | ✓ |
| Max dry spell (days) | 14 | 8–28 | ✓ |
| Max wet spell (days) | 7 | 5–16 | ✓ |
...
|-----------|---------------|-------------|--------|
| Soil pH | 5.5 | 4.8–6.9 | ✓ |
| Fertility (CEC) | 12 | 15–44 | ↓ |
| Soil texture | Sandy Loam | Unknown | ? |

→ Low fertility - add compost, feed little and often

### Suitability for Helsinki, Finland (Boreal)

**Climate zone**: Continental (✓ observed) — plant found in: Mediterranean, Humid Temperate, Continental

**Overall**: 👍 Good with minor adaptations
