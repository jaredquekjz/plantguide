...
|-----------|---------------|-------------|--------|
| Frost days/year | 0 | 4–90 | ↓ |
| Warm nights (>20°C) | 364 | 0–11 | ↑ |
| Growing season (days) | 365 | 275–365 | ✓ |
...
| Parameter | Your Location | Plant Range | Status |
|-----------|---------------|-------------|--------|
| Annual rainfall (mm) | 2302 | 416–1515 | ↑ |
| Max dry spell (days) | 9 | 11–26 | ↓ |
| Max wet spell (days) | 36 | 7–16 | ↑ |
...
**Climate zone**: Tropical (✗ not observed) — plant found in: Mediterranean, Humid Temperate
