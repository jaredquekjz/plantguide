...
output_global <- "shipley_checks/stage4/phase0_output/insect_fungal_parasites_11711.parquet"
...
output_filtered <- "shipley_checks/stage4/phase0_output/insect_fungal_parasites_11711_rust.parquet"
