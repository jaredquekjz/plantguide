...
# Output: shipley_checks/stage4/phase0_output/known_herbivore_insects.parquet
...
output_file <- "shipley_checks/stage4/phase0_output/known_herbivore_insects.parquet"
