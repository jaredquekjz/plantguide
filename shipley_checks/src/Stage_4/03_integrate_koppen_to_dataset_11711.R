...
#   - shipley_checks/output/stage3/bill_with_csr_ecoservices_11711_BILL_VERIFIED.csv (main dataset)
#
# Output:
...
MAIN_DATASET <- "shipley_checks/output/stage3/bill_with_csr_ecoservices_11711_BILL_VERIFIED.csv"
