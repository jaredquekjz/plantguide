#!/usr/bin/env python3
"""
Integrate Köppen distributions and tier assignments into bill_with_csr_ecoservices_11711_BILL_VERIFIED.csv.

Purpose:
- Merge plant_koppen_distributions_11711.parquet with bill_with_csr_ecoservices_11711_BILL_VERIFIED.csv
...
Input:
  ...
  - data/shipley_checks/output/stage3/bill_with_csr_ecoservices_11711_BILL_VERIFIED.csv (main dataset)
...
MAIN_DATASET = PROJECT_ROOT / "shipley_checks/output/stage3/bill_with_csr_ecoservices_11711_BILL_VERIFIED.csv"
...
File naming:
  - Input dataset: bill_with_csr_ecoservices_11711_BILL_VERIFIED.csv
